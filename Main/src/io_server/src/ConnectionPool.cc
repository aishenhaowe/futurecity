...
*****************************************************************************/
void ConnectionPool::Recycle(DataType *obj)
{
    obj->release();
...
*****************************************************************************/
int ConnectionPool::GetAliveCount()
{
...
*****************************************************************************/
int ConnectionPool::GetDeadCount()
{
...
*****************************************************************************/
set<DataType*>& ConnectionPool::GetAliveObjs()
{
    return m_aliveObjs;
}
